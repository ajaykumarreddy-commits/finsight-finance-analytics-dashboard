...
function Dashboard() {
  ...
  return (
    <div className="p-10 bg-gray-100 min-h-screen">
      <h1 className="text-3xl font-bold mb-2">Finance Analytics Dashboard</h1>
      ...
      <div className="bg-white p-6 rounded-lg shadow mb-8">
        <h2 className="text-xl font-bold mb-3">Monthly Budget</h2>
        ...
        {budget && (
          <div className="mt-4">
            ...
            <p className="mt-2 text-sm">{percent.toFixed(1)}% of budget used</p>
          </div>
        )}
      </div>
